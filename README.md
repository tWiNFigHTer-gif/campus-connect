...
**Part of the Campus Connect project** - Extracts accurate coordinates of colored nodes from SVG files for navigation systems.
...
This tool provides coordinate data for the Campus Connect navigation system. The extracted coordinates can be used to build navigation graphs and pathfinding algorithms.
